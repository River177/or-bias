...
ROOT = REPO_ROOT
EXP = artifact_path("runs/orbench-v2")
FROZEN_DIR = ROOT / "data" / "frozen" / "orbench-v2"
...
def main() -> None:
    ...
    parser.add_argument("--config", type=Path, default=ROOT / "configs" / "experiments" / "orbench-v2.yaml")
